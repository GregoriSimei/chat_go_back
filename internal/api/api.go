...
import (
	...
	"github.com/GregoriSimei/chat_go_back.git/internal/store/pgstore"
...
func NewHandler(q *pgstore.Queries) http.Handler {
	...
	r.Get("/subscribe/{room_id}", a.handleRoomSubscribe)
...
func (h apiHandler) handleRoomSubscribe(w http.ResponseWriter, r *http.Request) {
